...
<template>
    <div
        class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mx-6 my-6"
    >
        ...
        <div class="flex flex-col items-center pb-10">
            ...
            >
            <p
                class="mt-2 text-sm text-gray-500 dark:text-gray-400 whitespace-normal text-left max-w-sm px-5 break-words overflow-hidden"
            >
                Task Description
            </p>
